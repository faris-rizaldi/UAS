            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Daftar Team Masuk</h1>
                        ...
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                            $ambilsemuadatamasuk = mysqli_query($conn,"select * from masuk ,daftar  where idteam = idteam");
                            while($data= mysqli_fetch_array(($ambilsemuadatamasuk))){
                                    $tanggal = $data['tanggal'];
                                    $namateam = $data['namateam'];
                                    $poinmasuk = $data['poinmasuk'];
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <select name="teamnya" class="from-control">
            <?php
            ...
            <br>
        <input type="number" name="poinmasuk" class="from-control" placeholder="Poin Masuk" required><br>
        <br>
        <input type="text" name="keterangan"  class="from-control" placeholder="keterangan" require><br>
        <br>

        <button type="submit" class="btn btn-primary" name="addpoinmasuk">Submit</button>
        </div>
